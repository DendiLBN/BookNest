    ...
    <div className="home-page">
      <section className="home-page__hero">
        ...
        <p className="home-page__subtitle">
          Track books, filter by category, and quickly jump back to what matters
          most today.
        </p>
      </section>
      ...
      <section className="home-page__cards">
        <article className="home-page__card">
          ...
          <p>
            Start with 2-3 priority titles and keep your list focused on
            realistic goals.
          </p>
        </article>
        <article className="home-page__card">
          ...
          <p>
            Remove books you finished and tag new ones as soon as you add them.
          </p>
        </article>
        <article className="home-page__card">
